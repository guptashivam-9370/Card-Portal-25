...
import "../emailVerification/verification.css";
...
const OTPComponent = () => {
  ...
  const verifyOTP = async (email, otp, user_id) => {
    try {
  ...
  return (
    <div className="home-page">
      ...
      <div className="text">
        Welcome to Alcheringa!! To start with your journey, We need to verify you.
      </div>
      
      <div className="ver">
        <div className="verify">Verify Your Email ID</div>
        <div className="ver-text">
          Please enter your e-mail ID. A one-time-passcode will be sent on the same to verify your E-Mail ID.
        </div>
      </div>
        ...
        {otpSent ? (
          <>
            ...
            <p className='white' 
              ...
              style={{ cursor: canResendOTP ? 'pointer' : 'default', textDecoration: 'underline' }}>
              Resend OTP
            </p>
            <p className='white-in'>{countdown > 0 ? 'in' : ''}</p>
            <p className='green'>{countdown > 0 ? `${countdown} seconds...` : ''}</p>
          </>
        ): (<p></p>)}
        </div>
      </div> 
      ...
      <div className="the-otp">
        ...
        {correctOTP === false && <div className="error-message">Incorrect OTP</div>}
      </div>  
      <div className="pro">
        <button 
          className="proceed" 
        ...
        <img src="images/arrow1.svg" className="arrow" alt="" />
      </div>
      <Footer />  
    </div>
  );
